...
module.exports = (app) => {
  const { users, favorite, categories, products } = require('./routes');
  ...
  createCommonRoutes({ routeController: favorite, name: 'favorite', allPrivate: true });
  _.get('/favorites', favorite.getByUserId);
